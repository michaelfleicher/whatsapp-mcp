...
Running this project on Windows requires some extra setup (enabling CGO, installing a C compiler, etc.). See the full step-by-step guide in this repo: **[WINDOWS-SETUP-GUIDE.pdf](WINDOWS-SETUP-GUIDE.pdf)**.
